...
export default function Contact() {
  ...
  Get Started with the <br /> Next.js and React Revolution
</h1>
        ...
        <div className="flex gap-y-2 items-center flex-col sm:flex-row mx-auto sm:bg-white rounded-full p-2 shadow-md ">
          ...
          />
          <button className="flex items-center  px-4 py-2  text-black bg-white rounded-full font-semibold hover:bg-green-800">
            Join now
